...
// for easy.Setopt(OPT_HTTPAUTH, flag)
const (
	AUTH_NONE      = C.CURLAUTH_NONE
	AUTH_BASIC     = C.CURLAUTH_BASIC
	AUTH_DIGEST    = C.CURLAUTH_DIGEST
	AUTH_NEGOTIATE = C.CURLAUTH_NEGOTIATE
	AUTH_NTLM      = C.CURLAUTH_NTLM
	AUTH_DIGEST_IE = C.CURLAUTH_DIGEST_IE
	AUTH_NTLM_WB   = C.CURLAUTH_NTLM_WB
	AUTH_ONLY      = C.CURLAUTH_ONLY
	AUTH_ANY       = C.CURLAUTH_ANY
	AUTH_ANYSAFE   = C.CURLAUTH_ANYSAFE
)
